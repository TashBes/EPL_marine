...
Transform the CRS to match the ecosystem map. For both the ecosystem map and MPA layer the polygons of each ecosystem and protected area were combined together into multipolygons to simplify the data. 
